...
and neither tshark nor TelcoLens can read inside. The diagram shows a normal-looking
flow with no highlighted failure.

## Why this fixture exists

This is the honest limit of packet capture alone, and it is the reason TelcoLens
