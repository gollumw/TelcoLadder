...
def test_plugin_adapter_lands_in_its_declared_position(install_plugin):
    ...
    assert names == ["ngap", "s1ap", "faketel", "gtpv2", "sbi", "nas-5gs", "nas-eps", "sip", "megaco", "diameter", "sgsap", "pfcp", "gtp"]
...
def test_builtins_still_work_when_metadata_cannot_be_enumerated(monkeypatch):
    ...
    try:
        ...
        assert names == ["ngap", "s1ap", "gtpv2", "sbi", "nas-5gs", "nas-eps", "sip", "megaco", "diameter", "sgsap", "pfcp", "gtp"]
