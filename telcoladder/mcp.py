...
INSTRUCTIONS = (
    ...
    "fill them in. "
    "A cause number alone is not a conclusion - read what follows it. Where an ordered "
    "sequence of causes carries a known meaning, the procedure already has a 'sequence' "
    "field holding that meaning and the frames it was observed in; quote that, and quote "
    "the frames. Do not derive such a judgement yourself - if the field is absent, the "
    "table has no rule for what you are looking at, and inventing one is exactly the "
