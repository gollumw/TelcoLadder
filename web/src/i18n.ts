...
const zh_TW: Record<string, string> = {
  ...
  "Wide ladder": "梯形圖全寬",
  "Side by side": "左圖右表",
  "Give the ladder the full width; the inspector docks below": "梯形圖吃滿整頁寬度，解碼面板停到下方 —— 多看幾條泳道",
  "Ladder on the left, inspector on the right": "左邊梯形圖、右邊解碼面板 —— 逐則對照",
  "4G/5G interworking": "4G／5G 互通",
  "Other": "其他",
  "initial": "初始",
  "mobility update": "行動更新",
  "periodic": "週期性",
  "emergency": "緊急",
  "SNPN onboarding": "SNPN 入網",
  "disaster roaming mobility update": "災難漫遊行動更新",
  "disaster roaming initial": "災難漫遊初始",
  "{n} segment(s) in this group": "這一組有 {n} 段",
  "common cause: {cause}": "共同的 cause：{cause}",
  "Hide the segments": "收起各段",
  "Show the segments": "展開各段",
  "{n} segments · {f} failed": "{n} 段 · {f} 段失敗",
  "PDU modification": "PDU 修改",
  "EPS fallback": "EPS fallback（語音回落）",
  "Context transfer (N26)": "Context 交換（N26）",
  "TAU (4G)": "TAU（4G）",
  "Detach (4G)": "Detach（4G）",
  ...
  "By radio connection": "依無線連線",
  "Radio connections": "無線連線",
  "Frames {a}–{b}. From the InitialUEMessage the base station sent to the release completion.": "第 {a}–{b} 格。從基地台送出的 InitialUEMessage 到釋放完成。",
  "no procedure": "沒有程序",
  "{n} msgs": "{n} 則",
  "no release seen": "未見釋放",
  "Showing only radio connection #{n}: {m} message(s). Messages between two connections, such as the Paging that starts the next one, belong to none.": "只顯示第 {n} 次無線連線：{m} 則。兩次連線之間的訊息（例如開啟下一次連線的 Paging）不屬於任何一段。",
  "By scenario": "依場景類別",
  "By who started it": "依觸發側",
  "Radio side (UE, base station)": "無線側（手機、基地台）",
  "Core network": "核網",
  "Starter not identified": "判不出誰開的",
  "Showing only this segment's own messages: {n}": "只顯示這一段自己的訊息：{n} 則",
  "Show {n} other message(s) from the same time, dimmed": "淡色顯示同一時間的其他 {n} 則訊息",
  "Network functions on several addresses are drawn as one lane; click a lane name to show its addresses": "同一個網元的多個位址畫成一條泳道；點泳道名稱可展開各位址",
  "Collapse network functions": "收合網元",
  "Expand all network functions": "展開全部網元",
  "{n} addresses - click to show each: {list}": "{n} 個位址，點一下逐一展開：{list}",
  "Click to draw {nf} as one lane again": "點一下把 {nf} 收回成一條泳道",
  "Within {nf}: {from} → {to}": "{nf} 內部：{from} → {to}",
  "This browser refused clipboard access. The Mermaid text is selected below - press Cmd/Ctrl+C.": "這個瀏覽器拒絕寫入剪貼簿。Mermaid 文字已在下方全選，請按 Cmd/Ctrl+C 複製。",
  "Close": "關閉",
  "Packets": "封包清單",
  "Call Flows": "時序圖",
  "Calls (VoLTE/VoWiFi)": "通話（VoLTE／VoWiFi）",
  "Diameter": "Diameter",
  "This capture has no SIP, so there are no calls to list": "這份擷取檔沒有 SIP，沒有通話可列",
  "Scenario breakdown": "場景盤點",
  "{n} kind(s) of procedure": "{n} 種程序",
  "Scenario": "場景",
  "Total": "總計",
  "Succeeded": "成功",
  "Failed": "失敗",
  "Other outcomes": "其他結局",
  "Incomplete, ended by a party, or cancelled": "未完成、由一方結束，或已取消",
  "Most common cause": "最常見的 cause",
  "Open the first failure": "看第一次失敗",
  "Open ladder": "看時序圖",
  "Copy Mermaid": "複製 Mermaid",
  "Copied!": "已複製！",
  "Copy failed": "複製失敗",
  "Same text as telcoladder analyze -o flow.mmd for this subscriber": "與這個訂戶的 telcoladder analyze -o flow.mmd 逐字相同",
  "Export SVG": "匯出 SVG",
  "Download the ladder as it is drawn now": "下載目前畫面上的梯形圖",
  "Failure messages only": "只看失敗訊息",
  "Voice calls (VoLTE / VoWiFi)": "語音通話（VoLTE／VoWiFi）",
  "IMS registration and lookups": "IMS 註冊與查詢",
  "General sessions (4G/5G)": "一般 session（4G／5G）",
  "Unattributed": "未歸戶",
  "{call} call · {ims} IMS · {session} general · {flows} unattributed": "通話 {call} · IMS {ims} · 一般 {session} · 未歸戶 {flows}",
  "Access declared on the wire (P-Access-Network-Info)": "線路上宣告的接取（P-Access-Network-Info）",
  "The SIP requests carry no P-Access-Network-Info, so VoLTE and VoWiFi cannot be told apart": "SIP 請求沒有帶 P-Access-Network-Info，分不出是 VoLTE 還是 VoWiFi",
  "Times use the time zone chosen on the Overview (UTC by default)": "時間依總覽選的時區顯示（預設 UTC）",
  "Time zone": "時區",
  "Call start and end times are shown in this time zone. UTC by default, so a pasted time means the same instant on every machine.": "通話的開始與結束時間用這個時區顯示。預設 UTC，貼出去的時間在任何機器上都是同一個時刻。",
  "Start": "開始",
  "End": "結束",
  "{n} call(s) with problems, listed first": "{n} 通有問題，排在最前面",
  "Sort: {label}": "排序：{label}",
  ...
  "Attach (4G)": "Attach（4G）",
  "Handover": "換手",
  // 2026-09-13：類別標籤（`lib/procedureLabels.ts` 的 CATEGORY_LABEL）與網路觸發。
  "Mobility": "移動",
  "Session": "會話",
  "Release": "釋放",
  "Subscriber data": "訂戶資料",
  "Call": "通話",
  "Fallback": "回落",
  "network-triggered": "網路觸發",
  // 2026-09-12 新增的 4G／HSS 場景標籤 —— 當時沒有翻譯，因為沒有測試守著（`tests/test_procedure_labels.py`）。
  "Dedicated bearer setup": "專屬承載建立",
  "Dedicated bearer release": "專屬承載釋放",
  "Bearer modification": "承載修改",
  "PDN connection release": "PDN 連線釋放",
  "HSS cancel location": "HSS 取消位置",
  "Subscription data update": "訂閱資料更新",
  "Subscription data removal": "訂閱資料刪除",
  "Location update (HSS)": "位置更新（HSS）",
  "Authentication vectors (HSS)": "認證向量（HSS）",
  "Notify (HSS)": "通知（HSS）",
  ...
  "Full end-to-end": "完整端到端",
  "SIP only": "只有 SIP",
  "{n} SIP legs": "SIP {n} 腿",
  "end-to-end adds {megaco} H.248 · {diameter} Diameter · {enum} ENUM": "完整端到端另有 H.248 {megaco} 則 · Diameter {diameter} 則 · ENUM {enum} 則",
  "H.248 joins through the call's SDP media endpoints, Rf through its charging ID (ICID), HSS and ENUM lookups through the caller's or callee's international number within the call's time span.": "H.248 靠這通電話 SDP 的媒體端點接上，Rf 靠計費識別碼（ICID），HSS 與 ENUM 查詢靠主叫或被叫的國際號碼、而且落在通話期間內。",
  "{n} Diameter messages during this call carry no subscriber identity and were not attached - usually answers whose requests are not in the capture.": "通話期間有 {n} 則 Diameter 沒有任何訂戶身分，所以沒有接上 —— 通常是請求不在這份擷取檔裡的答覆。",
  "Frames: {frames}": "格：{frames}",
  "frames {a}–{b}": "第 {a}–{b} 格",
  "Caller ": "主叫 ",
  ...
  // 行為膠囊（2026-09-16）。
  "CS fallback (4G)": "CS fallback（4G）",
  "Initial registration": "初始註冊",
  "Registration update": "註冊更新",
  "UE-started service request": "手機發起的服務請求",
  "Paged service request": "被呼叫（Paging）的服務請求",
  "Inter-system handover (N26)": "跨代換手（N26）",
  "Inter-MME handover (S10)": "跨 MME 換手（S10）",
  "Path switch (Xn/X2)": "路徑切換（Xn/X2）",
  "Handover (N2/S1)": "換手（N2/S1）",
  "Idle mobility (N26)": "閒置移動（N26）",
  "VoLTE call": "VoLTE 通話",
  "CS fallback (SGs)": "CS fallback（SGs）",
  "IMS session": "IMS 會話",
  "Internet session": "上網會話",
  "Released by the RAN": "無線側釋放",
  "Released by the core": "核網釋放",
  "Voice": "語音",
  "Request": "請求",
  "Core turning point": "核網轉折點",
  "Final failure": "最終失敗",
  "Preparation": "準備",
  "Execution": "執行",
  "Post-dial delay (to 180/183)": "撥號後延遲（到 180/183）",
  "Time to answer": "接通時間",
  "Cx authentication": "Cx 認證",
  "Registration time": "註冊耗時",
  "Handover (preparation + execution)": "換手（準備＋執行）",
  "VoLTE post-dial delay": "VoLTE 撥號後延遲",
  "Registration (successful)": "註冊（成功）",
  "KPI thresholds": "KPI 閾值",
  "A behavior is marked SLOW when its measured time exceeds these seconds. Saved in this browser only.":
    "行為的量測時間超過這些秒數時標為「過慢」。只存在這個瀏覽器。",
  "Every threshold must be a number above zero.": "每個閾值都必須是大於零的數字。",
  "Restore defaults": "恢復預設",
  "Save": "儲存",
  "SLOW": "過慢",
  "Failed & slow only": "只看失敗與過慢",
