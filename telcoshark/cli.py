...
from telcoshark import __version__
from telcoshark.adapters import required_dissectors
from telcoshark.coverage import describe as describe_coverage
...
def build_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument("--version", action="version", version=f"telcoshark {__version__}")
...
def _force_utf8_output() -> None:
    ...
    **這個 bug 只在輸出被導向時出現。** 互動式 console 下 Python 走 Windows
    ...
    直到使用者寫 `telcoshark analyze x.pcap > flow.mmd` 才炸 —— 也就是
    README 教的那個用法。
